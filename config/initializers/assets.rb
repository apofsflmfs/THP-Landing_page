...
Rails.application.config.assets.paths << Rails.root.join("vendor/fonts/fontAwesome_icon_font")
Rails.application.config.assets.paths << Rails.root.join("vendor/fonts/linea_icon_font")
